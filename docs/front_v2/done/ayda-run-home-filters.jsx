...
// Sport Filter Chip Component
const SportChip = ({ sport, isSelected, onClick }) => (
  <button
    onClick={onClick}
...
// Sport Filter Popup - Compact pills with inline reset
const SportFilterPopup = ({ sports, selectedSports, onToggle, onClose, onClear }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative bg-white rounded-t-2xl w-full max-w-md p-4 pb-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-medium text-gray-800">Виды спорта</h3>
          <button 
            onClick={onClose}
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {/* Reset button - inline with pills */}
...
export default function AydaRunHome() {
  ...
  const [selectedSports, setSelectedSports] = useState([]); // sport ids
  ...
  const visibleSports = sportTypes.slice(0, VISIBLE_SPORTS);
  const hiddenSportsCount = sportTypes.length - VISIBLE_SPORTS;
  const hasHiddenSelected = selectedSports.some(id => 
    ...
    <div className="min-h-screen bg-white flex flex-col max-w-md mx-auto">
      ...
      <div className="border-b border-gray-200 px-4 py-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1 flex-1 justify-end">
            ...
            {/* +N button */}
            <button
              onClick={() => setShowSportPopup(true)}
          ...
          {/* Count */}
          <span className="text-sm text-gray-400 flex-shrink-0">{totalActivities}</span>
        </div>
      </div>
      ...
      {showSportPopup && (
        <SportFilterPopup
          ...
          onClose={() => setShowSportPopup(false)}
