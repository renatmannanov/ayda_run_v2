...
👥 Присоединиться к беговым клубам или создать свой
...
Если скрыть — будут видны только твои инициалы."""
...
🏠 Главная — твои тренировки и открытые активности в твоём городе

👥 Клубы и группы — спортивные сообщества, к которым можно присоединиться или создать своё
